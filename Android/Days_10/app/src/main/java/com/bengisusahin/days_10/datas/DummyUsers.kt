package com.bengisusahin.days_10.datas

import com.bengisusahin.days_10.models.Users
...
object DummyUsers {
    ...
    fun getUsers() : Users {
        val gson = Gson()
        // retrofitin yaptigi isi bizim tarafli yapmaca, sync islem
        val data = gson.fromJson(stringUsers, Users::class.java)
        return data
    }

    // private - dummyService e ulasan herkes usersa ulasamasın
